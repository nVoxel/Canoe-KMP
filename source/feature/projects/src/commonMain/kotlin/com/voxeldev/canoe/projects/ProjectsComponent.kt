...
class ProjectsComponent internal constructor(
    ...
    private val projectsDetailsComponent: (ComponentContext, String, () -> Unit) -> DashboardComponent,
    ...
    constructor(
        ...
        projectsDetailsComponent = { childContext, projectName, onDetailsCloseClicked ->
            DashboardComponent(
                componentContext = childContext,
                storeFactory = storeFactory,
                projectName = projectName,
                onCloseCallback = onDetailsCloseClicked,
            )
        },
    )
    ...
    private fun createChild(config: Config, componentContext: ComponentContext): Projects.Child =
        when (config) {
            ...
            is Config.ProjectsDetails -> Projects.Child.ProjectsDetailsChild(
                component = projectsDetailsComponent(componentContext, config.projectName, ::onDetailsCloseClicked),
            )
        }
    ...
    private fun onDetailsCloseClicked() = navigation.pop()
