...
) : AllTimeRepository, com.voxeldev.canoe.network.base.BaseNetworkRepository<AllTimeModel>(
    networkHandler,
    httpClient,
        ...
        doRequest<AllTimeResponse>(
            ...
            getFromCache = { useOutdatedCache ->
                allTimeDatabase.query(
                    ...
                    firstOrNull { it.project == request.project }?.let {
                        allTimeDatabaseMapper.toModel(
                        it,
                    )
                    } // realm bug?
                }
